...
* [Öppna aem-uberjar-demo-projekt på GitHub](https://github.com/justinedelson/aem-uberjar-demo)
* Hämta projektet som [en ZIP-fil](https://github.com/justinedelson/aem-uberjar-demo/archive/6.2-unobfuscated.zip)

>[!NOTE]
>
>Det går också att konfigurera dessa databaser i Maven- *filen settings.xml* .

Användare av andra byggsystem (till exempel Apache Ant, Gradle) bör följa liknande steg, anpassade till den specifika syntaxen för det verktyg de valt.
...
>[!NOTE]
>
>Om du inte importerar produktberoenden enligt beskrivningen ovan måste de också läggas till i den överordnade POM tillsammans med den version som matchar din AEM-konfiguration enligt beskrivningen ovan. Kommentarerna i varje post nedan visar det paket som du vill söka efter i Beroendesökaren.
