...
Funktionen som beskrivs här är bara tillgänglig om nodtypen `cq:Component` är tillgängligt i databasen.
...
Med CRXDE Lite kan du importera och/eller exportera nodtypsdefinitioner i [CND-notation (Compact Namespace and Node Type Definition)](http://jackrabbit.apache.org/jcr/node-type-notation.html).
