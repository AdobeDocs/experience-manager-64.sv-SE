...
1. Installera AEM.
1. Ange https://`<host>`:`<port>`/crx/de i webbläsaren. Som standard är det `http://localhost:4502/crx/de`.
...
Med CRXDE Lite kan du importera och/eller exportera nodtypsdefinitioner i [CND-notationen (Compact Namespace and Node Type Definition)](http://jackrabbit.apache.org/jcr/node-type-notation.html).
