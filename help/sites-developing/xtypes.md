...
* box
   ...
   Basklass för alla [komponenter](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Component) som ska storleksanpassas som en ruta, med bredd och höjd.
...
* contentfinder
   ...
   ContentFinder är en speciell [visningsruta](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Viewport) med två kolumner som innehåller den faktiska innehållssökaren till vänster och innehållsramen till höger.
...
* anpassad innehållpanel
   ...
   CustomContentPanel är en särskild panel som används i [CQ.Dialog](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Dialog): Innehållet hämtas från och skickas till en annan URL än de andra fälten i dialogrutan.
...
* datafält
   ...
   Innehåller ett datuminmatningsfält med listrutan [CQ.Ext.DatePicker](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.DatePicker) och automatisk datumvalidering.
...
* htmleditor
   ...
   Redigerarens knappar i verktygsfältet har knappbeskrivningar definierade i egenskapen [buttonTips](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.HtmlEditor) .
...
* listvy
   ...
   CQ.Ext.list.ListView är en snabb och lättviktsimplementering av en [stödrasterliknande](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.GridPanel) vy.
...
* mediabrowsedialog
   ...
   **Föråldrat: Använd[Innehållssökning](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.ContentFinder)för att bläddra bland media i stället.**
...
* panel
   ...
   Paneler ärvs genom arv från [CQ.Ext.Container](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Container).
...
* bildspel
   ...
   Bildspelskomponenten är baserad på [CQ.form.SmartImage](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.SmartImage) .
