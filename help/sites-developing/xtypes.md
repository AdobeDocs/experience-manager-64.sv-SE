...
En fullständig information om alla tillgängliga widgetar i AEM finns i [API-dokumentationen för widgeten](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html).
...
* box
   ...
   Basklass för alla [komponenter](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Component) som ska storleksändras som en ruta, med bredd och höjd.
...
* bläddringsdialogruta
   ...
   Med BrowseDialog kan användaren bläddra i databasen för att välja en sökväg. Det används vanligtvis via ett [BrowseField](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.BrowseField).
...
* webbläsarfält
   ...
   **Föråldrat: Använd  [CQ.form.](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.PathField) PathFieldIstället**
...
* kryssrutegrupp
   ...
   En grupperingsbehållare för kontrollerna [CQ.Ext.form.Checkbox](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.Checkbox).
...
* färgfält
   ...
   Med ColorField kan användaren ange ett hex-färgvärde antingen direkt eller med [CQ.Ext.ColorMenu](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.ColorMenu).
...
* contentfinder
   ...
   ContentFinder är en speciell två kolumner [Viewport](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Viewport) som innehåller den faktiska innehållssökaren till vänster och innehållsramen till höger.
...
* datafält
   ...
   Ger ett datuminmatningsfält med listrutan [CQ.Ext.DatePicker](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.DatePicker) och automatisk datumvalidering.
...
* datepicker
   ...
   En popup-datumväljare. Den här klassen används av klassen [DateField](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.DateField) för att tillåta bläddring och val av giltiga datum.
...
* redigeringsfält
   ...
   Även om det inte finns med här, innehåller EditBar alla medlemmar i [CQ.wcm.EditBase](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.EditBase).
...
* fältuppsättning
   ...
   Standardbehållare som används för att gruppera objekt i ett [formulär](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.FormPanel). ...
...
* htmleditor
   ...
   Redigerarens verktygsfältsknappar har verktygstips definierade i egenskapen [buttonTips](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.HtmlEditor).
...
* listvy
   ...
   CQ.Ext.list.ListView är en snabb och lätt implementering av en [Grid](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.grid.GridPanel)-liknande vy.
...
* lvcolumn
   ...
   Den här klassen kapslar in kolumnkonfigurationsdata som ska användas vid initieringen av en [ListView](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.list.ListView).
...
* mediabrowsedialog
   ...
   **Föråldrat: Använd  [Content ](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.wcm.ContentFinder) Finder för att bläddra bland media i stället.**
...
* panel
   ...
   Panelerna ärvs från [CQ.Ext.Container](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Container).
...
* password
   ...
   Lösenordet är som ett [CQ.Ext.form.TextField](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.TextField) men behåller sitt värde privat, vilket gör att användarna kan ange känsliga data.
...
* radiogrupp
   ...
   En grupperingsbehållare för kontrollerna [CQ.Ext.form.Radio](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.form.Radio).
...
* bildspel
   ...
   Bildspelskomponenten är baserad på komponenten [CQ.form.SmartImage](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.form.SmartImage).
...
* textknapp
   ...
   TextButton innehåller en textlänk med funktionerna i en [CQ.Ext.Button](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/widgets-api/index.html?class=CQ.Ext.Button).
