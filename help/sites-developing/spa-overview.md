...
>[!NOTE]
>
>Funktionen SPA (Single-Page Application Editor) kräver [AEM 6.4 Service Pack 2](/help/release-notes/sp-release-notes.md) eller senare.
>
...
AEM SDK för SPA introducerades med AEM 6.4 Service Pack 2. Det stöds fullt ut av Adobe, och som en ny funktion fortsätter den att förbättras och utökas. Följande AEM funktioner ingår ännu inte i SPA Editor:
