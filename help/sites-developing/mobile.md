...
1. Lägg till en **static.css** filen som innehåller stilarna för enhetsgruppen under `/etc/mobile/groups/special` nod.
...
AEM använder en trunkerad version av [WURFL](http://wurfl.sourceforge.net/index.php)™ -databas för att fråga efter enhetsfunktioner, som skärmupplösning eller stöd för javascript, baserat på enhetens User-Agent.
...
>[!NOTE]
>
>Mer information finns i [Anpassad BrowserMap](#using-browsermap-on-your-pages) -avsnitt.
