...
1. **Aktivera mallen**
   ...
   * [Aktivera mallen](/help/sites-authoring/templates.md#enabling-and-allowing-a-template-template-author) från **mallkonsolen** .
...
* Konfiguration - `/conf/<my-folder>/settings/wcm/templates/<my-template>`
   ...
   Sidkonfigurationen definieras av [mallen och relaterade innehållsprinciper](#template-definitions) .

* Modell - OSGi-paket

   I [OSGI-paketen](/help/sites-deploying/osgi-configuration-settings.md) implementeras funktionaliteten.
