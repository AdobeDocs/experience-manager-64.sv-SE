...
1. Läs in programmet We.Retail Journal antingen på publiceringsservern eller med alternativet **[!UICONTROL View as Published]** från **Sidinformation** i sidredigeraren.
...
1. Om den inte redan är inläst läser du in programmet We.Retail Journal på publiceringsservern eller använder alternativet **[!UICONTROL View as Published]** från **Sidinformation** i sidredigeraren.
