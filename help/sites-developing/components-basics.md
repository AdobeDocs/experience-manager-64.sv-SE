...
1. `cq:icon` - Strängegenskap som pekar på en standardikon i [Coral UI-biblioteket](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/coral-ui/coralui3/Coral.Icon.html) som ska visas i komponentwebbläsaren
