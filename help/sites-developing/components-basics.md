...
1. `cq:icon` - String-egenskap som pekar på en standardikon i [Coral UI-bibliotek](https://helpx.adobe.com/experience-manager/6-4/sites/developing/using/reference-materials/coral-ui/coralui3/Coral.Icon.html) som visas i komponentwebbläsaren
...
>* The [AEM](/help/sites-developing/modernization-tools.md) finns även för att hjälpa dig att utöka/konvertera komponenter som bara har dialogrutor definierade för det klassiska användargränssnittet.
>
