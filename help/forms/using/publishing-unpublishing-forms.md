...
* Cloud Service för Acrobat Sign, Typekit, reCAPTCHA och Form Data Models
...
1. Tryck ![verktyg-1](assets/tools-1.png)och sedan trycka **Forms**.
...
Med AEM Forms kan du schemalägga publicering och avpublicering av material för Forms &amp; Documents. Du kan ange schemat i metadataredigeraren. Mer information om hur du hanterar metadata för formulär finns i [Hantera formulärmetadata.](/help/forms/using/manage-form-metadata.md)
