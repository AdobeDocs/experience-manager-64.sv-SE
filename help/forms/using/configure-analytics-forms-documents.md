...
1. Klicka på i det övre vänstra hörnet **Adobe Experience Manager** > **verktyg** ![verktyg](assets/tools.png)> **Cloud Services** > **Äldre Cloud Services**.
...
1. Klicka **Forms > Forms &amp; Documents**, markera ett formulär eller dokument och klicka på **Aktivera analys**. Analysen är aktiverad.
   ...
   **S.** Knappen Aktivera analys **B.** Markerat formulär
   ...
   Detaljerad information om hur du visar analysrapporter för formulär finns i [Visa och förstå AEM Forms analysrapporter](/help/forms/using/view-understand-aem-forms-analytics-reports.md)
