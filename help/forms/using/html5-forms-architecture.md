...
![HTML5-formulär, ](assets/cacheworkflow.png)
**arbetsflödeBild:arbetsflöde för** *HTML5-formulär*
...
När en användare skickar formuläret skickar webbläsaren formulärets status i JSON-format till [tjänstproxyn](/help/forms/using/service-proxy.md); skickar tjänstproxyn data-XML med JSON-data och skickar XML-data till slutpunkten.
