...
**Bild:** *HTML5-formulärarbetsflöde*
...
När en användare skickar formuläret skickar webbläsaren formulärets status i JSON-format till [skicka tjänstproxy](/help/forms/using/service-proxy.md); skickar tjänstproxyn data-XML med JSON-data och skickar XML-data till slutpunkten.

## Komponenter {#components}

Du behöver AEM Forms tilläggspaket för att kunna aktivera HTML5-formulär. Information om hur du installerar AEM Forms tilläggspaket finns i [Installera och konfigurera AEM Forms](/help/forms/using/installing-configuring-aem-forms-osgi.md).
...
Om du vill uppdatera inställningarna går du till CQ Felix Admin Console (finns på `https://[server]:[port]/system/console/configMgr`) söker du efter och väljer Mobile Forms Configuration.
