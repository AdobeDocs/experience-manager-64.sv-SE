...
1. I konfigurationsdialogrutan anger du information för den databas som du vill konfigurera, till exempel:
   ...
   * Användarnamn och lösenord för anslutning till JDBC-drivrutinen
   ...
   >1. I **[!UICONTROL Plain Text]** anger du lösenordet eller en sträng som ska krypteras och klickar på **[!UICONTROL Protect]**.
...
1. Gå till **[!UICONTROL Tools > Cloud Services > Data Sources]**. Tryck för att välja den mapp där du vill skapa en molnkonfiguration.
   ...
   Se [Konfigurera mapp för molntjänstkonfigurationer](/help/forms/using/configure-data-sources.md#cloud-folder) om du vill ha information om hur du skapar och konfigurerar en mapp för molntjänstkonfigurationer.
