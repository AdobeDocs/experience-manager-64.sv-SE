...
1. Tryck på **[!UICONTROL Skapa]** för att öppna dialogrutan **** Skapa datakällkonfiguration. Ange ett namn och eventuellt en rubrik för konfigurationen, välj **[!UICONTROL RESTful Service]** i listrutan **[!UICONTROL Servicetyp]** , bläddra och välj en miniatyrbild för konfigurationen och tryck sedan på **[!UICONTROL Nästa]**.
...
1. Tryck på **[!UICONTROL Skapa]** för att öppna dialogrutan **** Skapa datakällkonfiguration. Ange ett namn och eventuellt en rubrik för konfigurationen, välj **[!UICONTROL SOAP-webbtjänst]** i listrutan **[!UICONTROL Servicetyp]** , bläddra och välj en miniatyrbild för konfigurationen och tryck sedan på **[!UICONTROL Nästa]**.
...
1. Tryck på **[!UICONTROL Skapa]** för att öppna dialogrutan **** Skapa datakällkonfiguration. Ange ett namn och eventuellt en rubrik för konfigurationen, välj **[!UICONTROL OData-tjänst]** i listrutan **[!UICONTROL Servicetyp]** , bläddra och välj en miniatyrbild för konfigurationen och tryck sedan på **[!UICONTROL Nästa]**.
