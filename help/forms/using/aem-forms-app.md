...
Mer information om hur AEM Forms-program fungerar med AEM Forms-servern finns i [Conard get assessment task](/help/forms/using/gov-reference-site-walkthrough.md#contard-assessment-task) i refsite-dokumentationen.
...
1. Om du vill hämta paketet öppnar du `https://<server>:<port>/crx/de/content/forms/mobileapps/src/adobe-lc-mobileworkspace-src-<version>.zip` i webbläsaren.
