...
[![microsoft-badge-ikon](assets/microsoft-badge-icon.png)](https://www.microsoft.com/en-us/store/p/adobe-experience-manager-forms/9nd12rlxtgtt)
...
Mer information om hur du använder AEM Forms-appar på AEM Forms-servrar finns i [Utvärderingsuppgift för konsol](/help/forms/using/gov-reference-site-walkthrough.md#contard-assessment-task) i dokumentationen till refsite.
...
1. Öppna om du vill hämta paketet `https://<server>:<port>/crx/de/content/forms/mobileapps/src/adobe-lc-mobileworkspace-src-<version>.zip` i webbläsaren.
