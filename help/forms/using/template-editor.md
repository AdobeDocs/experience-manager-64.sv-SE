...
1. I mallkonsolen trycker du **[!UICONTROL Create]** i den mapp du har skapat.
1. I avsnittet Välj en malltyp markerar du **[!UICONTROL Adaptive Form Template]** och trycker **[!UICONTROL Next]**.
...
1. Tryck för **[!UICONTROL Done]** att gå tillbaka till konsolen eller tryck för **[!UICONTROL Open]** att öppna mallen i redigeraren.
