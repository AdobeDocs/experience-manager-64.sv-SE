...
1. I mallkonsolen trycker du på **[!UICONTROL Skapa]** i den mapp du har skapat.
...
1. Leta reda på och öppna konfigurationsinställningarna för **[!UICONTROL FormsManager]** :
