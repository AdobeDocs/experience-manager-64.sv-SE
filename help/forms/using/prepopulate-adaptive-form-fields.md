...
* SERVICE_NAME refererar till namnet på OSGI-förifyllningstjänsten. Se [Skapa och köra en förifyllningstjänst](/help/forms/using/prepopulate-adaptive-form-fields.md#create-and-run-a-prefill-service).
