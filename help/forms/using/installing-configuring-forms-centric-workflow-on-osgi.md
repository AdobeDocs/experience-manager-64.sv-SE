...
>[!NOTE]
>
>Med Forms-baserade arbetsflöden i OSGi kan du snabbt skapa och distribuera arbetsflöden för olika uppgifter i OSGi-stacken, utan att behöva installera den fullständiga processhanteringsfunktionen i JEE-stacken. Se en [jämförelse](/help/forms/using/capabilities-osgi-jee-workflows.md) av de Forms-centrerade AEM arbetsflödena i OSGi och Process Management i JEE för att lära dig skillnaden och likheterna i funktionerna.
>
...
>[!NOTE]
>
>Gå till avsnittet [Nästa steg](#next-steps) i dokumentet om du redan har installerat AEM Forms på OSGi enligt beskrivningen i [Installera och konfigurera datainhämtningsfunktioner](/help/forms/using/installing-configuring-aem-forms-osgi.md)-artikeln.
