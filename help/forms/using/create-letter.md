...
* [Kompatibilitetspaket](https://helpx.adobe.com/in/experience-manager/6-4/forms/using/compatibility-package.html). Installera Kompatibilitetspaketet för att visa **Bokstäver** på **Forms** sida.

* Bokstaven XDP ([layout](/help/forms/using/document-fragments.md)).
* Andra XDP-filer ([layoutfragment](/help/forms/using/document-fragments.md)) som utgör delar av brevet. XDP:er\Layouts skapas i [Designer](http://www.adobe.com/go/learn_aemforms_designer_64).
