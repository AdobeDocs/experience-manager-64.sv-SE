...
Användarhantering lagrar användardata i en databas, t.ex. My SQL, Oracle, MS SQL Server och IBM DB2. Dessutom kan användare som har loggat in minst en gång i Forms-program på AEM författare `https://[*server*]:[*host*]/lc`, skapas användaren i AEM. Därför lagras användarhantering i följande datalager:
...
Användarhanteringsdata för användare som minst en gång har använt Forms-programmen under `https://[*server*]:[*host*]/lc` lagras även i AEM.
