...
1. Skapa regler på sidan Skapa ny publik. Med regler kan ni kategorisera målgruppen. Du vill till exempel kategorisera målgrupper baserat på operativsystem. Din målgrupp A kommer från Windows, och målgrupp B kommer från Linux.
   ...
   * Om du vill kategorisera målgrupper baserat på Windows väljer du **OS** attributtyp. I listrutan När väljer du **Windows**.
   * För att kategorisera målgrupper baserat på Linux väljer du **OS** attributtyp. I listrutan När väljer du **Linux** och klicka **Nästa**.
