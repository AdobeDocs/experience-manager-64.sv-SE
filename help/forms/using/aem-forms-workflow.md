...
description: Använd AEM Forms Workflow för att automatisera och snabbt bygga upp granskning och godkännanden, starta dokumenttjänster (t.ex. för att konvertera ett PDF-dokument till ett annat format), integrera med Adobe Sign signaturarbetsflöde med mera.
...
1. Välj **[!UICONTROL Create]** och sedan **[!UICONTROL Create Model]**. Dialogrutan Lägg till arbetsflödesmodell visas.
...
1. Skapa arbetsflödesfaser. Ett arbetsflöde kan ha flera steg. De här stegen visas i AEM Inkorg och rapporterar arbetsflödets förlopp.
   ...
   Om du vill definiera en scen trycker du på ikonen ![info-circle](assets/info-circle.png) för att öppna arbetsflödesmodellegenskaperna, öppnar fliken **[!UICONTROL Stages]**, lägger till faser för arbetsflödesmodellen och trycker på **[!UICONTROL Save & Close]**. I exemplet med låneansökan skapar du faser: låneansökan, låneanspråksstatus, signerade dokument och signerade lånedokument.

1. Dra och släpp webbläsaren för **[!UICONTROL Assign Task]** steg till arbetsflödesmodellen. Gör det till modellens första steg.
   ...
   I exemplet med låneansökan ska du konfigurera tilldelningssteget så att det använder ett skrivskyddat anpassat formulär och visa PDF-dokumentet när uppgiften är klar. Välj även en användargrupp som kan godkänna lånebegäran. Inaktivera alternativet **[!UICONTROL Submit]** på fliken **[!UICONTROL Actions]**. Ange en **[!UICONTROL Route Variable]**. Till exempel actionTaken. Lägg även till rutterna Godkänn och Avvisa. Vägarna visas som separata åtgärder (knappar) i AEM. Arbetsflödet väljer en gren baserat på den åtgärd (knapp) som användaren knackar på.
...
1. Dra och släpp OR-komponenten från stegwebbläsaren till arbetsflödesmodellen. Med ELLER-delning skapas en delning i arbetsflödet, varefter endast en gren är aktiv. I det här steget kan du lägga in sökvägar för villkorlig bearbetning i arbetsflödet. Du kan lägga till arbetsflödessteg i varje gren efter behov.
   ...
   **Kodfragment för gren 1**
   ...
   När en användare trycker på **[!UICONTROL Approve]** i AEM Inkorg aktiveras Förgrening 1.
   ...
   **Kodfragment för gren 2**
   ...
   När en användare trycker på **[!UICONTROL Reject]** i AEM Inkorg aktiveras gren 2.
...
1. Gå till ![tools](assets/tools.png) > **[!UICONTROL Forms]** > **[!UICONTROL Manage Workflow Application]** och tryck på **[!UICONTROL Create]** på din AEM författarinstans.
1. I fönstret Skapa arbetsflödesprogram anger du indata för följande fält och trycker på **[!UICONTROL Create]**. Ett nytt program skapas och visas på skärmen Arbetsflödesprogram.
...
Du kan konfigurera skicka-åtgärderna för ett adaptivt formulär så att ett arbetsflöde startas när det adaptiva formuläret skickas. Anpassade formulär innehåller åtgärden **[!UICONTROL Invoke an AEM Workflow]** skicka för att starta ett arbetsflöde när ett anpassat formulär skickas. Mer information om åtgärden Skicka finns i [Konfigurera åtgärden Skicka](/help/forms/using/configuring-submit-actions.md). Om du vill skicka ett adaptivt formulär via appen AEM Forms aktiverar du Synkronisera med AEM Forms App i de adaptiva formuläregenskaperna.
...
1. Gå till ![tools](assets/tools.png) **[!UICONTROL Forms > Configure Watched Folder]** på AEM författarinstans. En lista över redan konfigurerade bevakade mappar visas.
...
<table> 
 <tbody> 
  ...
  <tr> 
   ...
   <td>Välj alternativet <span class="uicontrol">Arbetsflöde </span>. </td> 
  </tr> 
  <tr> 
