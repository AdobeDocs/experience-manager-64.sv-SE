...
AEM Forms utnyttjar och utökar möjligheterna i era befintliga investeringar i XFA-formulär och Adobe LiveCycle.
...
AEM Forms har verktyg för blanketthantering som inte bara gör det möjligt att hantera adaptiva formulär, utan även XFA-formulär, PDF forms och relaterade resurser. Mer information finns i [Introduktion till hantering av formulär](/help/forms/using/introduction-managing-forms.md).
