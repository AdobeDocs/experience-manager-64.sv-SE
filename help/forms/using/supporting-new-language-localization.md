...
* Begäranparameter `afAcceptLang`
   ...
   Om du vill åsidosätta webbläsarens språkområde för användare kan du skicka parametern request för att `afAcceptLang` tvinga fram språkområdet. Följande URL kommer till exempel att tvinga formuläret att återges på japanska språk:
