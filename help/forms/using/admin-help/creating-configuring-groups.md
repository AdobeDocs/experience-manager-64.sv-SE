...
Användare kan få en långsammare svarstid om de tillhör många grupper (till exempel 500 eller fler) eller om grupperna är djupt inkapslade (till exempel 30 nivåer). Om det här problemet uppstår kan du konfigurera AEM formulär så att information hämtas i förväg från vissa domäner. (Se [Konfigurera AEM formulär för att hämta domäninformation](/help/forms/using/admin-help/configure-aem-forms-prefetch-domain.md#configure-aem-forms-to-prefetch-domain-information)i förväg.)
