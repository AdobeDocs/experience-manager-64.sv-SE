...
1. Välj Nyckelupplösning för användarhanterarens affärskalender i listan Används av systemet.
...
1. I administrationskonsolen klickar du på Tjänster > Formulärarbetsflöde > Affärskalendrar och sedan på fliken Mappning.
1. Välj Grupper som definierats av katalogservern i listan System kommer att använda.
