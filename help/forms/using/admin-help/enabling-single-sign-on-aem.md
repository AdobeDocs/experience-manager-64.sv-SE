...
Om du använder datornamnet för att få åtkomst till servern, till exempel https://lcserver:8080*,*, krävs inga inställningar för Internet Explorer. Om du anger en URL som inte innehåller några punkter (&quot;.&quot;) behandlas platsen som en lokal intranätsplats i Internet Explorer. Om du använder ett fullständigt kvalificerat namn för webbplatsen måste webbplatsen läggas till som en betrodd plats.
