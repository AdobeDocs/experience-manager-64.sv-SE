...
1. I dialogrutan bläddrar du till och väljer paketet eller arkivet som ska importeras. Du kan också välja PDF-dokument, XSD, bilder, formatmallar och XDP-formulär. Tryck **Öppna**.
...
1. Tryck på verktyg ( ![verktyg-1](assets/tools-1.png)) och sedan trycka **Forms**.
...
1. Tryck på **Hämta exporterat paket** för att ladda ned paketfilen.
   ...
   Om du vill lägga till resurserna i paketet i en annan instans av Correspondence Management, [importera paketet till en AEM Forms-instans](/help/forms/using/import-export-forms-templates.md#p-upload-forms-documents-assets-p).
