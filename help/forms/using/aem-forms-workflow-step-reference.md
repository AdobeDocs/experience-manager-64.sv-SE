...
* **Använd adaptiv form:** Ange metod för att hitta indataadaptiv form. Du kan använda det adaptiva formulär som finns på en absolut sökväg, som skickas som nyttolast till arbetsflödet eller som finns på en sökväg som beräknas med en variabel. Du kan använda en variabel av typen String för att ange sökvägen.
...
* **Information som ska fyllas i i förväg:** Följande fält nedan fungerar som indata för uppgiften:
   ...
   * **Sökväg till bifogad fil:** Bifogade filer på platsen bifogas till formuläret som är associerat med uppgiften. Sökvägen är alltid relativ till nyttolasten. En exempelsökväg är [Payload_Directory]/attachments/
...
* **Skickad information:** Följande fält i listan nedan fungerar som utdataplatser för uppgiften:
   ...
   * **Dokumentsökväg:** Sökväg för att spara en postfil. Exempel: [Payload_Directory]/DocumentofRecord/credit-card.pdf. Postdokumentet genereras inte om sökvägsfältet lämnas tomt. Sökvägen är alltid relativ till nyttolasten.
...
* **Deltagare:** Fältet är tillgängligt när  **[!UICONTROL com.adobe.granite.workflow.core.process.RandomParticipantChooser]** alternativet är markerat i fältet Deltagare. I fältet kan du välja användare eller grupper för alternativet RandomParticipantChooser.
...
* **Standardåtgärder:** Utanför är åtgärderna Skicka, Spara och Återställ tillgängliga. Som standard är alla standardåtgärder aktiverade.
* **Flödesvariabel:** namn på flödesvariabeln. Vägvariabeln hämtar anpassade åtgärder som en användare väljer i AEM Inkorg.
* **Routningar:** En aktivitet kan grenas till olika vägar. När du väljer det här alternativet i AEM Inkorg returnerar flödet ett värde och arbetsflödesgrenarna baserat på det valda flödet.
...
I e-poststeget används Day CQ Mail Service för att skicka e-post. Innan du använder e-poststeget kontrollerar du att [e-posttjänsten](/help/forms/using/aem-forms-workflow.md) är konfigurerad. E-poststeget har följande egenskaper:
...
**E-postämne:** Ämne kan hämtas från ett arbetsflödes metadata eller anges manuellt. Välj alternativet **Literal** om du vill ange ett ämne manuellt eller välj alternativet **Hämta från arbetsflödesmetadata** om du vill hämta ämnet från en metadataegenskap.
...
**Avsändarens/mottagarens e-postadress:** Markera alternativet  **** Lista om du vill ange en e-postadress manuellt eller markera alternativet  **Hämta från arbetsflödets** metadata om du vill hämta e-postadressen från en metadataegenskap. Du kan också ange en lista med egenskapsmatriser för metadata för alternativet **Hämta från arbetsflödesmetadata**.

**Sökväg till bifogad fil:** Den tillgängliga resursen på den angivna platsen bifogas till e-postmeddelandet. Resursens sökväg kan vara relativ till nyttolasten eller den absoluta sökvägen. En exempelsökväg är [Payload_Directory]/attachments/

**Filnamn:** Namn på e-postbilagefilen. E-poststeget ändrar det ursprungliga filnamnet för den bifogade filen till det angivna filnamnet. Namnet kan anges manuellt eller hämtas från en metadataegenskap för arbetsflöde. Använd alternativet **Literal** när du vet exakt vilket värde som ska anges. Använd alternativet **Hämta från arbetsflödesmetadata** när värdet som ska användas sparas i en metadataegenskap för arbetsflöde.
...
**Sökväg till bifogad** indatafil:sökväg till bifogad indatafil: Sökväg till de bifogade filerna. De här bifogade filerna ingår i dokumentdokumentet. Du kan behålla de bifogade filerna på en plats i förhållande till nyttolasten eller ange en absolut sökväg för de bifogade filerna.
...
**Genererad sökväg till postdokument:** Ange platsen där ett postdokument ska sparas. Du kan välja att skriva över nyttolastmappen eller placera postdokumentet på en plats i nyttolastkatalogen.
...
* **Indata för tjänster > Ange indata med hjälp av litteral, arbetsflödesmetadata och en JSON-fil**: En tjänst kan ha flera argument. Välj alternativet för att hämta värdet för tjänstargumenten från en metadataegenskap för arbetsflöde, ett JSON-objekt eller ange värdet direkt i textrutan:
   ...
   * **Mappa indatafält från JSON-indata:** Ange sökvägen till en JSON-fil för att få indatavärdet för vissa tjänstargument från JSON-filen. JSON-filens sökväg kan vara relativ till nyttolasten eller en absolut sökväg.

* **Ange för tjänster > Ange indata med en JSON-fil:** Välj alternativet att hämta värden för alla argument från en JSON-fil.
...
* **Utdata för tjänst > Spara utdata som JSON:** Välj alternativet att spara utdatavärdena i en JSON-fil.
* **JSON-utdatafilsökväg:** sökväg för att spara JSON-utdatafilen. Sökvägen till JSON-utdatafilen kan vara relativ till nyttolasten eller en absolut sökväg.
...
* **Adobe Sign Cloud-konfiguration**: Välj en Adobe Sign Cloud-konfiguration. Om du inte har konfigurerat Adobe Sign för AEM Forms kan du läsa [Integrera Adobe Sign med AEM Forms](/help/forms/using/adobe-sign-integration-adaptive-forms.md).
...
AEM dokumenttjänster är en uppsättning tjänster för att skapa, sammanställa och skydda PDF-dokument. AEM Forms tillhandahåller ett AEM arbetsflödessteg för varje dokumenttjänst:
...
### Återge PDF-formulärsteg {#render-pdf-form-step}
