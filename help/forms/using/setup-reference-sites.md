---
title: Konfigurera referensplatser för AEM Forms
seo-title: Konfigurera referensplatser för AEM Forms
...
# Konfigurera referensplatser för AEM Forms {#set-up-and-configure-aem-forms-reference-sites}
...
* **Grundläggande om AEM**
   ...
   AEM QuickStart, AEM Forms tilläggspaket och referenspaket för webbplatser. Mer information om paket med tillägg och referensplatser finns i [AEM Forms-releaser](https://helpx.adobe.com/aem-forms/kb/aem-forms-releases.html) .
...
* En instans av AEM 6.4 med tilläggsprogrammet Forms som körs. Mer information finns i [Installera och konfigurera AEM Forms](installing-configuring-aem-forms-osgi.md).
...
Konfigurera ditt Analytics-konto så som beskrivs i [Konfigurera analyser och rapporter](/help/forms/using/configure-analytics-forms-documents.md)om du vill använda den här funktionen på referenswebbplatsen.
...
1. Kontrollera att det finns analyskonfigurationer för We.Finance och We.Gov i AEM cloud services. Du kan hitta molntjänster på något av följande sätt:
   ...
   * Klicka på under **[!UICONTROL Cloud Services]** avsnitt på **[!UICONTROL Adobe Analytics]** sidan `Show Configurations`. Du kan se vilka konfigurationer för We.Finance och We.GOV som är tillgängliga. Klicka för att öppna konfigurationen. Klicka på på konfigurationssidan **[!UICONTROL Edit]**. Ange ett giltigt företag, användarnamn, delad hemlighet (lösenord) och datacenter och klicka på **[!UICONTROL Connect to Analytics]**. När du har öppnat dialogrutan Anslutningen klickar du **[!UICONTROL OK]** på konfigurationsdialogrutan. Konfigurera ramverket under Analytics-konfigurationen enligt beskrivningen i [Konfigurera Analytics och Rapporter](/help/forms/using/configure-analytics-forms-documents.md).
