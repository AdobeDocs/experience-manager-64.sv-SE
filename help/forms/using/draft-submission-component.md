...
# Komponenten {#drafts-and-submissions-component} för utkast och inskickning
...
Om du vill att ett anpassat formulär ska visas på fliken Skicka anger du **Skicka-åtgärden** till **[Forms Portal Submit Action](/help/forms/using/configuring-submit-actions.md).** Du kan också aktivera alternativet Skicka i Forms Portal. När en användare skickar formuläret läggs formuläret till på fliken Skicka.
...
I AEM Forms-dokumentationen finns ett [exempel för integrering av utkast och inskickningskomponenter i databasen](https://helpx.adobe.com/in/experience-manager/6-4/forms/using/integrate-draft-submission-database.html). Du kan använda exempelimplementeringen för att utveckla en egen anpassad implementering.
