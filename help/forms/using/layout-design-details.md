...
* I Designer klickar du på **[!UICONTROL File > Form Properties > Default]** och se till att inställningen för återgivning/format i PDF är inställd på dynamiskt XML-formulär.
