...
1. På **[!UICONTROL Basic]** fliken väljer du den [konfigurationsbehållare](/help/forms/using/adobe-sign-integration-adaptive-forms.md#configure-adobe-sign-with-aem-forms) som skapades när du konfigurerade Adobe Sign med AEM Forms.
1. In the **[!UICONTROL Form Model]** tab, select one of the following options:
...
När du har [redigerat anpassningsbara formuläregenskaper för Adobe-signering](#enableadobesign)gör du följande för att lägga till ett molnsignaturfält i ett anpassat formulär:
...
**Ans:** Nej, AEM Forms har inte stöd för att använda ett adaptivt formulär som bäddar in ett adaptivt formulär som kan användas i Adobe Sign för signering.
...
**Ans:** Ja, du kan använda texttaggar i en textkomponent för att lägga till Adobe Sign-fält i ett anpassat formulär som är aktiverat för ett [postdokument](/help/forms/using/generate-document-of-record-for-non-xfa-based-adaptive-forms.md) (endast det automatiskt genererade postdokumentet). Mer information om proceduren och reglerna för att skapa en texttagg finns i [Adobe Sign Documentation](https://helpx.adobe.com/sign/help/text-tags.html). Dessutom har adaptiva formulär begränsat stöd för texttaggar. Du kan använda texttaggarna för att skapa endast de fält som stöds av Adobe Sign Block.
