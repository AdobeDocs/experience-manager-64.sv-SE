...
1. Dra och släpp **[!UICONTROL Customer ID]** från fliken Formulärobjekt till ID-fältet i dialogrutan **[!UICONTROL INPUT]** box. Fält utan ett prefix-tabellnamn (t.ex. kundinformation i det här fallet) fungerar som sökparametrar för uppdateringstjänsten. The **[!UICONTROL id]** i det här användningsfallet identifierar unikt en post i kundinformationsregistret.
...
1. Tryck på **[!UICONTROL Customer ID]** och tryck på `Edit Rules` ikon. Regelredigeraren öppnas.
1. Tryck på **[!UICONTROL + Create]** om du vill lägga till en regel. Den öppnar Visual Editor.
