...
1. Navigera till **[!UICONTROL Lokal datorprincip > Datorkonfiguration > Windows-inställningar > Skyddsinställningar > Lokala principer > Tilldelning]** av användarrättigheter och redigera **[!UICONTROL Ersätt en token]** på processnivå och inkludera gruppen Administratörer.
...
1. Logga in på AEM-författarinstansen och gå till **[!UICONTROL Adobe Experience Manager > Verktyg > Formulär > Konfigurera PDF-generator]**. Standardwebbadressen är http://localhost:4502/libs/fd/pdfg/config/ui.html.
