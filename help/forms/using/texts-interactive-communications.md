...
1. Välj **`[!UICONTROL Forms]`** > **[!UICONTROL Dokumentfragment]**.
...
](assets/toolbarselection.png) Verktygsfältet ![Teckensnittsredigering](do-not-localize/paragraphtoolbar-1.png)
