...
1. **AEM:** AEM arbetsflöden kan också användas som efterbearbetning för skickade brev. Instruktioner för konfiguration [AEM](/help/forms/using/aem-forms-workflow.md).
