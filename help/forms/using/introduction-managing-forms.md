...
på en portalserver för slutanvändare. Du kan använda användargränssnittet i AEM Forms för att:
...
* **** Importera filer från lokal lagring: Du kan importera PDF-formulär och -dokument, formulärmallar (XFA-formulär) och andra resurser (bild- och XML-schema för XSD-filer). Stegvisa instruktioner finns i [Importera och exportera resurser till AEM-formulär](/help/forms/using/import-export-forms-templates.md).
...
Mer information om hur du skapar och använder teman finns i [Teman i AEM-formulär](/help/forms/using/themes.md).
...
AEM-verktygspanelen innehåller verktyg för olika komponenter. Om du vill navigera till AEM Forms-specifika verktyg klickar du på **Experience Manager-logotypen** ![adobeexperienceManager](assets/adobeexperiencemanager.png) > **tools** ![hammer](assets/hammer.png) > **Forms**. Verktyg för följande funktioner visas:
...
* **** Vänster räl: Du kan klicka på den vänstra ikonen ![för att rita](assets/railleftpng.png) upp tidslinjen och referera till funktioner i AEM-formulär.
   ...
   * **** Tidslinje: Du kan lägga till och visa kommentarer för en resurs som är tillgänglig för granskning på tidslinjen. Detaljerade anvisningar finns i [Skapa och hantera granskningar för resurser i formulär](/help/forms/using/create-reviews-forms.md).
...
* **** Visa växlare: Du kan klicka på ![visningslistan](assets/viewlist.png) eller ![vykortet](assets/viewcard.png) för att snabbt växla mellan list- och kortvyn. Mer information om vanliga användargränssnittskomponenter finns i [Arbeta med redigeringsmiljön](/help/sites-authoring/basic-handling.md).
