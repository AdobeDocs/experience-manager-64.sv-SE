...
>[!NOTE]
>
>I det här avsnittet används API:t för att hämta information om slutpunktsanslutningar `ConnectorRegistryClient` . (Se [AEM Forms API Reference](https://www.adobe.com/go/learn_aemforms_javadocs_63_en).)
