...
Med ett klientprogram kan du skicka *FirstAppSolution/PreLoanProcess- *bearbetningen av nödvändiga XML-data. En långvarig process returnerar ett anropsidentifierarvärde som returvärde. Följande bild visar klientprogram som anropar* den långvariga processen FirstAppSolution/PreLoanProcess *. Klientprogrammen skickar XML-data och hämtar tillbaka ett strängvärde som representerar anropsidentifierarvärdet.
