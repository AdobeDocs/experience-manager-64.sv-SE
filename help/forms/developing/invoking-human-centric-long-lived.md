...
Med ett klientprogram kan du skicka *FirstAppSolution/PreLoanProcess *bearbeta de XML-data som behövs. En långvarig process returnerar ett anropsidentifierarvärde som returvärde. Följande bild visar klientprogram som anropar* FirstAppSolution/PreLoanProcess *långvarig process. Klientprogrammen skickar XML-data och hämtar tillbaka ett strängvärde som representerar anropsidentifierarvärdet.
...
Webbsidan* index.html *ger en startpunkt till Java-servern som anropar `FirstAppSolution/PreLoanProcess` -processen. Den här webbsidan är ett grundläggande formulär i HTML som innehåller ett HTML-formulär och en skicka-knapp. När användaren klickar på skicka-knappen skickas formulärdata till `SubmitXML` Java servlet.
