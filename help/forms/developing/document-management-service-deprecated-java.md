...
I följande Java-kodexempel skapas ett nytt utrymme med namnet *Test Directory *som finns i företagshem. ID-värdet för det nya utrymmet skrivs till konsolen.
