...
Det här DDX-dokumentet sammanfogar två PDF-dokument med namnet *map.pdf* och* Directions.pdf* i ett och samma PDF-dokument. Det resulterande PDF-dokumentet innehåller en rubrik som består av en unik sididentifierare. Dokumentet i ovanstående bild visar till exempel 000016.
