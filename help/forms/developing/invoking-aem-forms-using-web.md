...
>[!NOTE]
>
>Vi rekommenderar att du inte överskrider 30 MB när du fyller i ett `BLOB` objekt genom att anropa dess `setBinaryData` metod. Annars kan det uppstå ett `OutOfMemory`*-undantag.*
...
1. Lägg till följande Axis JAR-filer i Java-projektets klassökväg:
   ...
   * xercesImpl.jar
   ...
   Dessa JAR-filer finns i *[installationskatalogen]*/Adobe/Adobe Experience Manager Forms/sdk/lib/thirdparty.
