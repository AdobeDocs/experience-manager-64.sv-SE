...
1. Skapa en BAT-fil för att köra Ant-byggskriptet. Följande kommando kan finnas i en BAT-fil som ansvarar för att köra Ant-byggskriptet:
   ...
   >[!NOTE]
   >
   >Det finns olika sätt att lägga in JAVA-filer i en JAR. Ett sätt är att använda en Java IDE som Eclipse. Skapa ett Java-projekt och skapa en `com.adobe.idp.services`* package (all .JAVA-fil tillhör detta paket). Importera sedan alla JAVA-filer till paketet. Exportera projektet som en JAR-fil.*
...
1. Lägg till följande Axis JAR-filer i Java-projektets klassökväg:
   ...
   * xercesImpl.jar
   ...
   Dessa JAR-filer finns i *[installationskatalog]*/Adobe/Adobe Experience Manager Forms/sdk/lib/thirdparty directory.
