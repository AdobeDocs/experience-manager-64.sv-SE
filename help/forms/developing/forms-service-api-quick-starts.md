...
I följande kodexempel återges formuläret *Loan.xdp *på klienten med hjälp av Java API:t för Forms-tjänsten. Observera att formulärdesignen är en del av ett program och att den refereras genom att använda innehållsrots-URI-värdet `repository:///`. (Se [Återge formulär på klienten](/help/forms/developing/rendering-forms.md#rendering-forms-at-the-client).)
