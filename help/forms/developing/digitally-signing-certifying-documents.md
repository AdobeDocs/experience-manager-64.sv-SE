...
* Validera digitala signaturer i ett PDF-dokument. (Se [Verifierar digitala signaturer](#unresolvedlink-lc-si).)
* Validera alla digitala signaturer i ett PDF-dokument. (Se [Verifierar flera digitala signaturer](#unresolvedlink-lc-si).)
...
Iterera genom varje signatur. Det vill säga, för varje signatur, verifiera den digitala signaturen och kontrollera signerarens identitet och status för varje signatur. (Se [Verifierar digitala signaturer](#unresolvedlink-lc-si).)
