...
>[!NOTE]
>
>I detta sammanhang innebär termen ytterligare innehållet i appen.[programnamn].addition.[locale]XML-fil. En sådan fil anger åsidosättningar och tillägg till XML-filen i dialogrutan.
...
Namnet på XML-filen för den extra dialogrutan måste ha formattillägget.*[programnamn]*.addition.*[locale]*.xml, där *programnamn* måste exakt matcha det programnamn som används i XML-konfigurationsfilen och i skriptet.
...
Skapa en miljövariabel som anger platsen för det interna programmets körbara fil. Variabeln måste använda formatet *[programnamn]*_PATH, där *programnamn* måste exakt matcha det programnamn som används i XML-konfigurationsfilen och i skriptet, och där sökvägen till den körbara filen finns inom citattecken. Ett exempel på en sådan miljövariabel är `Photoshop_PATH`.
...
1. I dialogrutan Ny systemvariabel, i **Variabelnamn** anger du ett namn som använder formatet *[programnamn]* SÖKVÄG.
