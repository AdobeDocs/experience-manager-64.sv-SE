...
I följande Java-kodexempel sammanfogas två PDF-källdokument med namnen* map.pdf* och *directions.pdf* till ett enda PDF-dokument. Namnet på det enskilda PDF-dokumentet är *AssemblerResultPDF.pdf*. DDX-dokumentets namn är *shell.xml*. (Se [Programmatisk sammansättning av PDF-dokument](/help/forms/developing/assembling-pdf-documents.md#programmatically-assembling-pdf-documents).)
