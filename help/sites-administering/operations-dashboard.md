...
1. Uppgiften **Revision Clean Up **finns under **Daglig underhållsperiod** -menyn.

1. Uppgiften **Lucene Binaries Cleanup **som finns under **Daglig underhållsperiod** -menyn.

1. Aktiviteten **Workflow purge **finns under **Underhållsfönster varje vecka** -menyn.
...
Mer information om Revision Clean Up for AEM 6.4 finns i [se den här dedikerade artikeln](/help/sites-deploying/revision-cleanup.md).
...
>[!NOTE]
>
>Mer information om underhåll av arbetsflöden finns i [den här sidan](workflows-administering.md#regular-purging-of-workflow-instances).
