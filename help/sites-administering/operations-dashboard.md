...
1. Uppgiften **Revision Clean Up **finns under menyn **Dagligt underhållsfönster**.
...
>[!NOTE]
>
>Mer information om underhåll av arbetsflöden finns på [den här sidan](workflows-administering.md#regular-purging-of-workflow-instances).
