...
Med [AEM Communities 6.1](/help/communities/overview.md) -tillägget löses problemet genom att en [gemensam butik används för UGC](/help/communities/working-with-srp.md). När det gäller personalisering omfattar Communities [Social Login](/help/communities/social-login.md) - möjlighet att ge besökare möjlighet att logga in med Facebook och Twitter.
