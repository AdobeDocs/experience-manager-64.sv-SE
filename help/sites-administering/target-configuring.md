...
Om du vill hitta molnkonfigurationen och ramverket går du till **Cloud Service** via **Verktyg** > **Distribution** > **Cloud**. ([http://localhost:4502/libs/cq/core/content/tools/cloudservices.html](http://localhost:4502/libs/cq/core/content/tools/cloudservices.html))\
Klicka eller tryck på **Visa konfigurationer** nedan Adobe Target.
