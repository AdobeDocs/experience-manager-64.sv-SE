...
Aktivera Dynamic Tag Management-tjänsten för distributionskoppling för att få åtkomst till AEM så att tjänsten kan uppdatera AEM bibliotek. Ange IP-adressen till de dynamiska Tag Management-servrar som uppdaterar testnings- och produktionsbiblioteken efter behov:
