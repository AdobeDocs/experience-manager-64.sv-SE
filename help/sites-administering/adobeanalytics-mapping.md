...
1. Om du vill göra ramverket tillgängligt på publiceringsinstansen på webbplatsen öppnar du fliken **Sida **och klickar på **Aktivera Framework.**
...
1. När **AEM** kan listan filtreras beroende på vilken variabeltyp som väljs med hjälp av de tre filterknapparna:
   ...
   * Om **Trafik** om knappen är markerad visas endast de variabler som tillhör avsnittet Trafik i listan
...
1. I Adobe Analytics-vyn visar Content Finder alla CQ-variabler som tillhör spårningskomponenterna som dras i CQ-vyn.
   ...
   * t.ex. om komponenten **Download **är *endast en dragd* i CQ-vyn (som har två mappningsbara variabler *eventdata.downloadLink* och *eventdata.events.startDownload*) kommer Content Finder att se ut så här när du växlar till Adobe Analytics-vyn:
