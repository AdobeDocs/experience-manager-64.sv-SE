...
Om du vill spara data från MD5-tjänsten på jsontest.com-webbplatsen ska du följa proceduren i [Skapa ett ContextHub Store](/help/sites-administering/contexthub-config.md#creating-a-contexthub-store) med följande egenskaper:
...
Använd proceduren i [Lägga till en gränssnittsmodul](/help/sites-administering/contexthub-config.md#adding-a-ui-module) för att lägga till användargränssnittsmodulen i ett befintligt användargränssnittsläge, till exempel exemplet UI-läge. Använd följande egenskapsvärden för UI-modulen:
