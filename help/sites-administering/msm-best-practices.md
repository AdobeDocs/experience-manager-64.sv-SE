...
>[!NOTE]
>
>CUG-grupper kan inte rullas ut till Live-kopior från utkast. Se till att du undviker detta när du konfigurerar Live Copy.
...
>[!NOTE]
>
>Detta fungerar endast med [Vid utrullningsutlösare](https://helpx.adobe.com/experience-manager/6-3/sites/administering/using/msm-sync.html#rollout-triggers).
