...
* **Page Editor (Dynamic Media Classic [tidigare Scene7] sök)**:
   ...
   Den här konfigurationen definierar de alternativ som är tillgängliga när du söker efter Dynamic Media Classic-resurser i resursläsaren (när du redigerar en sida).
...
1. Navigera till **verktyg**, **Operationer**, **Sök i Forms**.
