...
1. Ange **[!UICONTROL Company]** namnet och **[!UICONTROL Root Path]** (det här är det publicerade servernamnet tillsammans med sökvägen som du vill ange; om du inte känner till det publicerade servernamnet går du till **[!UICONTROL Setup > Application Setup]** i Dynamic Media Classic.)
...
1. Klicka på **[!UICONTROL OK]**. AEM sparar din konfiguration.
...
1. Tryck på **[!UICONTROL Advanced]** fliken, markera **[!UICONTROL Enable Automatic Upload]** kryssrutan och tryck sedan på **[!UICONTROL OK]**. Du måste nu konfigurera arbetsflödet för DAM-resurser så att det omfattar överföring till Dynamic Media Classic.
...
1. Gå tillbaka till AEM-välkomstsidan och tryck **[!UICONTROL Workflows]**. Dubbelklicka på arbetsflödet **DAM Update Asset** för att öppna det.
1. Navigera till komponenterna i **[!UICONTROL Workflow]** sidosparken och markera **[!UICONTROL Dynamic Media Classic]**. Dra **[!UICONTROL Dynamic Media Classic]** till arbetsflödet och tryck på **[!UICONTROL Save]**. Resurser som läggs till i AEM Assets i målmappen överförs automatiskt till Dynamic Media Classic.
...
1. Välj önskad konfiguration i listrutan och tryck på **[!UICONTROL Adobe Dynamic Media Classic]** den **[!UICONTROL OK]**.
...
1. På Adobe Experience Manager Web Console Configuration-panelen trycker du på **[!UICONTROL OSGi]** menyn **[!UICONTROL Configuration]**.
...
* Kontrollera att du har konfigurerat molnkonfigurationen för den sidan genom **[!UICONTROL Page Properties]**. Videoförinställningar är tillgängliga i videokomponenten i Dynamic Media Classic.
