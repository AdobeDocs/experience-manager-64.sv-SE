...
1. Ange **[!UICONTROL Company]** namnet och **[!UICONTROL Root Path]** (det här är det publicerade servernamnet tillsammans med sökvägen som du vill ange; om du inte känner till namnet på den publicerade servern går du till **[!UICONTROL Setup > Application Setup]** i Dynamic Media Classic.)
...
1. Gå tillbaka till AEM välkomstsida och tryck **[!UICONTROL Workflows]**. Dubbelklicka på arbetsflödet **DAM Update Asset** för att öppna det.
...
Du kan kontrollera detta genom att navigera till en Dynamic Media Classic-komponent på en sida i AEM och trycka **[!UICONTROL Edit]**. Resursen kommer att ha den säkra förhandsvisningsservern angiven i URL:en. När du har publicerat i AEM uppdateras serverdomänen i filreferensen från förhandsgransknings-URL:en till produktions-URL:en.
...
## Felsökning av Dynamic Media Classic och AEM {#troubleshooting-scene-and-aem-integration}
...
* Kontrollera att du har konfigurerat molnkonfigurationen för den sidan genom **[!UICONTROL Page Properties]**. Videoförinställningar är tillgängliga i videokomponenten Dynamic Media Classic.
