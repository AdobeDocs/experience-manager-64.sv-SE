...
>[!NOTE]
>
>Allt kampanjinnehåll ska skapas under en `master` sida av typen `cq/personalization/components/ambitpage`. Om du till exempel planerar en kampanjstruktur ser det ut ungefär så här:
>
