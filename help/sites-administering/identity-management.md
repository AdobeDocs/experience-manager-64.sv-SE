...
>[!NOTE]
>
>Den information som anges i profilen kan även användas för att förse användaren med riktat innehåll via [Segment](/help/sites-administering/campaign-segmentation.md) och [Kampanjer](/help/sites-authoring/personalization.md).
...
/home alla tillåter jcr:read rep:glob = &amp;ast;/profile&amp;ast;
