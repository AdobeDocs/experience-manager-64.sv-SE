...
>[!NOTE]
>
>Efter en uppgradering till 6.4 bör du flytta filen från /etc. Se [Omstrukturering av de gemensamma tillgångarna i AEM 6.4](/help/sites-deploying/all-repository-restructuring-in-aem-6-4.md#translation-rules) för mer information.
...
I redigeraren kan du markera/avmarkera **I`s Deep`** i **Filter** -fliken.
