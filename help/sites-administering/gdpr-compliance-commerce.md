...
För vissa e-handelsplattformar lagrar vi profilinformation ( `/home/users`) och e-handelstoken (för inloggning på e-handelsplattformen) i AEM. I dessa fall ska du läsa [Hantera GDPR-förfrågningar för AEM Platform](/help/sites-administering/handling-gdpr-requests-for-aem-platform.md).
...
För hybris- och IBM WebSphere-integreringarna finns det vissa data i AEM. Du bör använda [AEM GDPR-anvisningar](/help/sites-administering/handling-gdpr-requests-for-aem-platform.md) och överväga följande frågor:
