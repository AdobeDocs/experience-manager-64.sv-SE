...
Dessutom kan följande ämnen vara av intresse när du integrerar AEM med [Adobe Campaign](https://docs.campaign.adobe.com/doc/standard/en/home.html):
...
1. Välj **Adobe Experience** Manager i fältet **Typ** och ange de åtkomstparametrar som används för AEM. serveradress, kontonamn och lösenord.
...
* Se även [Felsöka AEM/Adobe Campaign-integreringen](/help/sites-administering/troubleshooting-campaignintegration.md).
...
Se [Konfigurera externaliseraren](/help/sites-developing/externalizer.md) för allmänna instruktioner. För integreringen med Adobe Campaign måste du se till att du konfigurerar publiceringsservern `https://<host>:<port>/system/console/configMgr/com.day.cq.commons.impl.ExternalizerImpl` inte vid någon punkt `localhost:4503` utan vid en server som kan nås av Adobe Campaign Console.
