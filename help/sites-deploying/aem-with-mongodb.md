...
Mer information om hur du konfigurerar MongoDB med Amazon Web Services finns i följande guide för [MongoDB på AWS](https://docs.aws.amazon.com/quickstart/latest/mongodb/welcome.html).
