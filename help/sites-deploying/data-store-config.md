...
* `db`: Namn på Mongo-databasen. Standardvärdet är **Oak** . Nya AEM 6-installationer använder **aem-author** som standarddatabasnamn.
...
För att aktivera S3-datalagrets funktioner måste ett funktionspaket som innehåller S3 Datastore Connector hämtas och installeras. Gå till [Adobe Repository](https://repo.adobe.com/nexus/content/groups/public/com/adobe/granite/com.adobe.granite.oak.s3connector/) och ladda ned den senaste versionen från 1.8.x-versionerna av funktionspaketet (till exempel com.adobe.granite.oak.s3connector-1.8.0.zip). Dessutom måste du ladda ned och installera det senaste AEM Service Pack som finns på [AEM 6.4 Service Pack versionsinformation](https://helpx.adobe.com/experience-manager/6-4/release-notes/feature-packs-release-notes.html) .

>[!NOTE]
>
>När du använder AEM 6.4 med tarMK lagras binärfiler som standard i `FileDataStore`. Om du vill använda tarMK med S3-datastore måste du starta AEM med `crx3tar-nofds` runmode, till exempel:
...
1. Om AEM redan har konfigurerats för att fungera med lagringen tar du bort alla befintliga konfigurationsfiler från `aem-install/crx-quickstart/install` mappen innan du fortsätter. De filer som behöver tas bort är:
...
1. Gå till inställningarna för replikeringsagenten genom att öppna en sida till *http://localhost:4502/etc/replication/agents.author/publish.html*.
...
>[!NOTE]
>
>När du använder AEM 6.4 med tarMK lagras binärfiler som standard i FileDataStore. Om du vill använda tarMK med Azure DataStore måste du starta AEM med `crx3tar-nofds` runmode, till exempel:
...
1. Söker efter **RepositoryManagement.** När du har hittat Repository Manager MBean klickar du på den för att visa tillgängliga alternativ.
