...
>[!NOTE]
>
>När du använder AEM 6.4 med tarMK lagras binärfiler som standard i FileDataStore. Om du vill använda tarMK med Azure DataStore måste du starta AEM i `crx3tar-nofds` runmode, till exempel:
