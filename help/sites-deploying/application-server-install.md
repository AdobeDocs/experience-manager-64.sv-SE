...
Om du använder distributionsskannern för att installera AEM-webbprogrammet kan det vara bra att öka värdet `deployment-timeout,` för det angivna `deployment-timeout` attributet i xml-filen för instansen (t.ex. `configuration/standalone.xml)`:
