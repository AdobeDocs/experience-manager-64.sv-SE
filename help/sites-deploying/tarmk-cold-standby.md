...
>
>Detta kan du göra genom att gå till *http://localhost:4502/system/console/status-slingsettings* och kontrollera **&quot;Körningslägen&quot;** linje.
...
1. Stoppa synkroniseringsprocessen på den kalla standby-instansen genom att gå till JMX-konsolen och använda **org.apache.jackrabbit.oak: Status (&quot;Standby&quot;)** böna. Mer information om hur du gör detta finns i avsnittet om [Övervakning](#monitoring).
