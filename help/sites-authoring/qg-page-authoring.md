...
Innan du ger en översikt över specifika detaljer finns det en liten samling allmänna tips och tips som du bör tänka på, särskilt om du är van vid [klassisk gränssnittsredigeringsmiljö](/help/sites-classic-ui-authoring/classicui.md).
...
* Arbetsflöden och versioner har inte längre startats/skapats från sidredigeraren. detta görs nu från [Tidslinje](/help/sites-authoring/basic-handling.md#timeline) (kan nås från konsolen).
...
1. Navigera uppåt i trädet med [sidhuvudet](/help/sites-authoring/basic-handling.md#the-header)som gör att du kan gå tillbaka till den valda platsen:
...
1. Kortvy:
   ...
   * Ange markeringsläge med [välja nödvändig resurs](/help/sites-authoring/basic-handling.md#viewing-and-selecting-resources) med:
...
* Från **Webbplatser** konsol:
   ...
   1. Välj **Snabbpublicering** ikon från antingen
      ...
      * [Snabbåtgärder (endast kortvyn/skrivbordet)](#quick-actions-card-view-desktop-only) för rätt resurs.
      * Verktygsfältet när [sidan har valts](#selecting-your-page-for-further-action) (ger även tillgång till [Publicera senare](/help/sites-authoring/publishing-pages.md#manage-publication)).
