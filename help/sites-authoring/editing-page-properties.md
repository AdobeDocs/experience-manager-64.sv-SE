...
* **Autentiseringskrav**
   ...
   Kravet på autentisering kan anges här tillsammans med en angiven inloggningssida. Stängda användargrupper för sidan definieras på fliken **[Behörigheter](/help/sites-authoring/editing-page-properties.md#permissions)**.
