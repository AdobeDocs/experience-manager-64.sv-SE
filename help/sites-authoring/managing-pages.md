...
* Författarmiljö: `http://localhost:4502/editor.html/content/we-retail/us/en/products/equipment/hiking/desert-sky-shorts.html`

* Publiceringsmiljö: `http://localhost:4503/content/we-retail/us/en/products/equipment/hiking/desert-sky-shorts.html`
...
Den här strukturen kan visas Från konsolen **Platser**, där du kan [navigera bland sidorna på webbplatsen](/help/sites-authoring/basic-handling.md#product-navigation) och utföra åtgärder på sidorna. Du kan också skapa nya webbplatser och [nya sidor](#creating-a-new-page).
...
När du har skapat och öppnat en sida kan du [lägga till innehåll med komponenterna](/help/sites-authoring/editing-content.md#inserting-a-component), som är tillgängliga i [komponentwebbläsaren](/help/sites-authoring/author-environment-tools.md#components-browser).
...
1. Välj sida genom att använda något av följande:
   ...
   * [Markeringsläge ](/help/sites-authoring/basic-handling.md#product-navigation) och verktygsfältet

   Välj sedan ikonen **Redigera**:

   ![screen_shot_2018-03-22at105355](assets/screen_shot_2018-03-22at105355.png)

1. Sidan öppnas och du kan [redigera sidan](/help/sites-authoring/editing-content.md) efter behov.
...
1. Om sidan är länkad till eller refererad visas dessa referenser i steget **Justera/Publicera om**. Du kan ange vilka som ska justeras och publiceras på nytt efter behov.
