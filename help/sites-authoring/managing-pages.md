...
Den här strukturen kan visas på **Webbplatser** konsol, där du kan [navigera bland sidorna på webbplatsen](/help/sites-authoring/basic-handling.md#product-navigation) och utför åtgärder på sidorna. Du kan också skapa nya webbplatser och [nya sidor](#creating-a-new-page).
...
När du har skapat och öppnat en sida kan du [lägga till innehåll med komponenterna](/help/sites-authoring/editing-content.md#inserting-a-component)som är tillgängliga från [komponentwebbläsare](/help/sites-authoring/author-environment-tools.md#components-browser).
...
1. Om sidan är länkad till eller refererad visas dessa referenser i **Justera/publicera igen** steg. Du kan ange vilka som ska justeras och publiceras på nytt efter behov.
