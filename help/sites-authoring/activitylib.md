...
>
>Mer information finns i [Förutsättningar för att integrera med Adobe Target](/help/sites-administering/target-requirements.md) .
...
1. Select the activity and click or tap **View Properties **and click the **Reports** tab and select the activity that you want to view performance for/convert winning experiences for. Resultatdata visas.

   ![chlimage_1-239](assets/chlimage_1-239.png)

1. Klicka på eller tryck på länken **** Push-vinnare för att använda den upplevelsen som standard.
