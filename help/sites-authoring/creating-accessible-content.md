...
* kanske inte kan komma åt information som presenterats av en författare i en *vanlig* tvådimensionell flerspaltig webbsidlayout
...
* **Använda rubriker:**
   ...
   Så länge du har tillgänglighetsfunktionerna i textredigeraren aktiverade (se [AEM och hjälpmedel](#AdobeExperienceManagerandAccessibility)) har AEM tre rubriknivåer. Du kan använda dessa för att identifiera avsnitt och underavsnitt för innehåll. Rubrik 1 är den högsta rubriknivån, rubrik 3 den lägsta. Systemadministratören kan konfigurera systemet så att fler rubriknivåer tillåts.
...
* Felaktigt exempel:
   ...
   * Text: Om du vill ha information om våra kvällskurser för hösten 2010 klickar du <u>här</u>.
...
* Om en sida är skriven på engelska ska `<html>` elementet vara: `<html lang = “en-gb”>`
