...
seo-title: Läs om AEM 6.4-funktioner
...
# Läs mer om AEM 6.4-funktioner {#learn-about-aem-64-capabilities}
...
Läs mer om [Adobe Experience Manager 6.4 Foundation](/help/sites-deploying/home.md) och vår driftsättningsmodell för hanterade tjänster eller dyk in i några av våra [nya videopresentationer av funktionerna i den här versionen.](https://helpx.adobe.com/experience-manager/kt/sites/index/aem-6-4-sites.html)
