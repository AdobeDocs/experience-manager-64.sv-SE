...
* Om båda behålls skapas en ny resurs med ett unikt namn för den publicerade resursens URL. Till exempel är **[!UICONTROL image.jpg]** den ursprungliga resursen och **[!UICONTROL image1.jpg]** den nyligen överförda resursen.
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td><p>Så här avgör du om videokodning fortfarande pågår eller om den har försatts i ett feltillstånd:</p> 
    <ul> 
     <li>Kontrollera videostatusen <code>http://localhost:4502/crx/de/index.jsp#/content/dam/folder/videomp4/jcr%3Acontent</code> &gt; <span class="kbd">dam:assetState</span></li> 
