...
description: Hur man lägger in material i AEM, lägger in metadata, skapar renderingar och aktiverar dem för publicering.
contentOwner: AG
...
Innan du utför något av stegen i den här metoden bör du granska och implementera vägledningen i [Resursens tips för prestandajustering](performance-tuning-guidelines.md). Många av stegen, som att konfigurera maximalt antal samtidiga jobb, förbättrar i hög grad serverns stabilitet och prestanda vid inläsning. Andra steg, som att konfigurera ett fildatalager, är mycket svårare att utföra efter att systemet har lästs in med resurser.
...
## Migrera resurser mellan AEM-distributioner {#migrating-between-aem-instances}
