...
seo-description: Lär dig mer om den centraliserade hanteringen av videoresurser, där du kan överföra videor för automatisk kodning till Dynamic Media Classic och få tillgång till Dynamic Media Classic-videor direkt från AEM Assets. Integrering med Dynamic Media Classic gör att optimerad video kan användas på alla skärmar.
