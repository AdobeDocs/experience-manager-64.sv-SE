...
* **[!UICONTROL Titel, Alt-text]** På fliken **[!UICONTROL Avancerat]** lägger du till en titel i bilden och alternativ text för användare som har bilder inaktiverade.
...
* **[!UICONTROL Konfiguration]** av Dynamic Media Classic: Välj den konfiguration av Dynamic Media Classic som du vill använda för att hämta aktiva bildförinställningar från SPS.
...
* **[!UICONTROL Brytpunkter]** Om webbplatsen är responsiv vill du justera brytpunkterna. Brytpunkter måste avgränsas med kommatecken ( , ).
...
* **[!UICONTROL Typ av resurs]** Välj **[!UICONTROL Dynamic Media Classic]** för att bläddra i dynamiskt media Classic-innehåll. Det här alternativet är endast tillgängligt om Dynamic Media Classic har konfigurerats.
