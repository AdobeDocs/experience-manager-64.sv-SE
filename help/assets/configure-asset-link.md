...
1. Skapa [anpassat frågeindex](#create-custom-index), konfigurera [FPO-återgivningar](https://helpx.adobe.com/enterprise/using/configure-aem-assets-6-for-asset-link.html#configfporendition) för InDesign och konfigurera [Integrering med Adobe Stock](/help/assets/aem-assets-adobe-stock.md).
...
| Visuell eller liknande sökning | NA |
...
>[!NOTE]
>
>* Den utökade korrigeringen för affärsprofiler finns i Experience Manager 6.4.8.4.
...
I Experience Manager 6.4 kan administratörer konfigurera arbetsflöden så att resurser automatiskt körs och bearbetas baserat på fördefinierade villkor.
...
Experience Manager innehåller index som används för frågor. Skapa följande anpassade index för den angivna versionen. Experience Manager 6.4.0 innehåller detta index som standard. Adobe Asset Link kräver det här indexet för att avgöra vilka resurser en användare har checkat ut.
