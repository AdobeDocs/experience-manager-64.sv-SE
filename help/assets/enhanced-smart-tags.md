...
Smart Content Service är en molntjänst som är värd för [!DNL Adobe I/O]. För att kunna använda programmet i Adobe Experience Manager måste systemadministratören integrera [!DNL Experience Manager] instans med [!DNL Adobe I/O].
...
Administratören kan följa länken för att integrera Smart Content Service med [!DNL Experience Manager] . Integrera tjänsten med [!DNL Experience Manager] Resurser, se [Konfigurera smarta taggar](config-smart-tagging.md).
...
Granska sedan bilderna för att identifiera en uppsättning bilder som bäst motsvarar din produkt för ett visst affärsbehov. Se till att resurserna i din aktuella uppsättning följer [Utbildningsriktlinjer för smarta innehållstjänster](smart-tags-training-guidelines.md).
...
>1. Läs [Utbildningsriktlinjer för smarta innehållstjänster](smart-tags-training-guidelines.md) innan du påbörjar utbildning för någon tagg.
...
Du kan aktivera tjänsten Smart Content Service för att med jämna mellanrum utbilda resurser och tillhörande taggar i en mapp. Öppna egenskapssidan för resursmappen och välj **[!UICONTROL Enable Smart Tags]** under **[!UICONTROL Details]** och spara ändringarna.
...
1. Tryck/klicka på [!DNL Experience Manager] logotyp och gå till **[!UICONTROL Tools > Workflow > Models]**.
...
1. Ange en rubrik för arbetsflödet och lägg till en kommentar. Tryck/klicka sedan **[!UICONTROL Run]**. Resurserna och taggarna skickas in för utbildning.
...
1. Tryck/klicka på [!DNL Experience Manager] logotyp och gå till **[!UICONTROL Tools > Assets > Reports]**.
...
1. Ange en rubrik för arbetsflödet och en valfri kommentar. Tryck/klicka sedan **[!UICONTROL Run]**.
