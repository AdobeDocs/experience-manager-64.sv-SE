...
description: Bästa tillvägagångssätt för att övervaka miljön och prestanda för din [!DNL Experience Manager] instans efter att den har distribuerats.
contentOwner: AG
...
Vanligtvis kan [!DNL Assets] övervakas på två sätt: live-övervakning och långtidsövervakning.
...
* [!DNL Experience Manager] error.log-fil: Du kan undersöka filen  [!DNL Experience Manager] error.log om du vill ha mer information om fel som har loggats i systemet. Använd kommandot `tail -F quickstart/logs/error.log` för att identifiera fel som du bör undersöka.
...
Vanligtvis använder du de här verktygen tillsammans för att få en heltäckande bild av hur din [!DNL Experience Manager]-instans fungerar.
...
Om du råkar ut för problem i samband med övervakningen finns det några felsökningsuppgifter som du kan utföra för att lösa vanliga problem med [!DNL Experience Manager]-instanser:
