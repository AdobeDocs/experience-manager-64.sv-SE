...
|  | Hörn | Obligatoriskt.<br> Hörnet på bilden som används för att definiera bakgrundsfärgen som ska blockeras.<br> Du kan välja mellan **Övre vänster**, **Nederst till vänster**, **Övre höger**, eller **Nederst till höger**. |
