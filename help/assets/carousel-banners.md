...
1. Gör något av följande:
   ...
   * [Lägg till en karusellbanderoll på din webbplats i ](adding-dynamic-media-assets-to-pages.md) AEMIom du är AEM Sites-kund kan du lägga till karuselluppsättningen direkt på sidan i AEM med hjälp av komponenten Interactive Media.
...
* Om du vill visa alla utgående HTTP-begäranden i Google Chrome trycker du på F12 (Windows) eller Command-Option-I (Mac) för att öppna panelen Utvecklarverktyg och sedan på fliken **[!UICONTROL Network]**.
...
Information om hur du överför bildbanderoller finns i [Överföra resurser](managing-assets-touch-ui.md).

## Skapar Carousel-uppsättningar {#creating-carousel-sets}

>[!NOTE]
>
>Icke-administrativa användare måste läggas till i **[!UICONTROL dam-users]**-gruppen för att kunna skapa eller redigera karusellbanderoller. Om du har problem med att skapa eller redigera kontaktar du systemadministratören som kan lägga till dig i **dam-users**-gruppen.
...
1. På sidan **[!UICONTROL Carousel Banner Editor]** trycker du på **[!UICONTROL Tap to open Asset Selector]** för att välja bilden för den första bilden.

   Gör något av följande på sidan **[!UICONTROL Carousel Banner Editor]**:
...
Kom ihåg att spara ditt arbete när du lägger till hotspot-områden eller bildscheman i en bild. **[!UICONTROL Undo]** och  **[!UICONTROL Redo]** alternativ, i det övre högra hörnet av sidan, stöds under den aktuella skaps-/redigeringssessionen.
...
1. Markera karuselluppsättningen och tryck på **[!UICONTROL Edit]**.
...
1. Gör något av följande på fliken **[!UICONTROL Actions]**:
   ...
   * Tryck på **[!UICONTROL Quickview]**.
      ...
      * Om du är kund inom AEM Sites och e-handel trycker du på ikonen **[!UICONTROL Product Picker]** (förstoringsglas) för att öppna sidan **[!UICONTROL Select Product]**. Tryck på den produkt du vill använda och tryck sedan på bockmarkeringen i det övre högra hörnet av sidan för att gå tillbaka till **[!UICONTROL Carousel Banner Editor]**.
   ...
   * Tryck på **[!UICONTROL Hyperlink]**.
      ...
      * Om du är kund hos AEM Sites trycker du på ikonen **[!UICONTROL Site Selector]** (mapp) för att navigera till en URL.
   ...
   * Tryck på **[!UICONTROL Experience Fragment]**.
      ...
      * Om du är kund hos AEM Sites trycker du på ikonen **[!UICONTROL Search]** (förstoringsglas) för att öppna sidan Experience Fragment. Tryck på det Experience Fragment som du vill använda och tryck sedan på **[!UICONTROL Select]** i det övre högra hörnet på sidan för att gå tillbaka till sidan för hantering av hotspot.
...
1. Om du vill redigera Carousel-uppsättningen gör du något av följande:
   ...
   * Om du vill lägga till en bildruta trycker du på ikonen **[!UICONTROL Add Slide]**, navigerar till den resurs du vill lägga till i bildrutan och trycker på bockmarkeringen.
...
Du kan använda **[!UICONTROL Preview]** för att se hur karusellbanderollen kommer att se ut för kunderna och för att testa karusellbanderollernas hotspot-områden och bildscheman så att de beter sig som förväntat.
...
1. I **[!UICONTROL Assets]** navigerar du till en befintlig Carousel-banderoll som du har skapat och trycker för att öppna den.
1. I närheten av det övre vänstra hörnet på sidan **[!UICONTROL Preview]** trycker du på ikonen **[!UICONTROL Content]**.
...
Se [Publicera Dynamic Media Assets](publishing-dynamicmedia-assets.md) för mer information om hur du publicerar Carousel-banners.
