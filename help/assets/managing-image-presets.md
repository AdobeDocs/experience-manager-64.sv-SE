...
### Skapa Dynamic Media-bildförinställningar {#creating-image-presets}
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td><p>Välj <strong>Ingen</strong>, <strong>Skärpa</strong> eller <strong>Oskarp mask</strong>. </p> 
    ...
    <div>
      Skärpa beskrivs i 
     <a href="https://docs.adobe.com/content/help/en/experience-manager-64/assets/dynamic/assets/s7_sharpening_images.pdf">Skärpa bilder</a>. 
    </div> </td> 
  </tr> 
  <tr> 
