...
Aktivitetsloggarna som ska visas på tidslinjen hämtas från platsen `/var/audit/com.day.cq.dam/content/dam` i CRX, där loggfilerna lagras.
...
>[!NOTE]
>
>Standardplatsen för logglagring för **publicerings** - och **avpubliceringsåtgärder** är `/var/audit/com.day.cq.replication/content`. Standardplatsen för **Flytta** -uppgifter är `/var/audit/com.day.cq.wcm.core.page`.
