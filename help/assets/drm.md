...
1. Välj **[!UICONTROL References]** på menyn.
   ...
   För förfallna resurser visas förfallostatusen **[!UICONTROL Asset is Expired]** högst upp på referenslinjen.

   ![chlimage_1-147](assets/chlimage_1-147.png)

   Om resursen har upphört att gälla visas statusen **[!UICONTROL Asset has Expired Sub-Assets]** på referenspanelen.
...
1. Klicka på alternativet **[!UICONTROL Expiry Status]** för att expandera det.
...
1. På fliken Avancerat anger du ett förfallodatum för resursen i fältet **[!UICONTROL Expires]**.
