...
* Anger om standardmetoden för SRP, [JSRP](jsrp.md), används eller inte
...
>[!NOTE]
>
>Observera att om SRP lämnas som standard till [JSRP](jsrp.md) så visas den UGC som anges i publiceringsinstansen endast vid publicering och *inte *visas från [moderation](moderate-ugc.md)-konsolen på författarinstansen.
