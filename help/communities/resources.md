...
* **[!UICONTROL Add Image]**
   ...
   (*valfri*) En bild som ska visas på kortet för aktiveringsresursen på medlemmens uppdragssida samt på resurskonsolen. Bilden väljs från serverns lokala filsystem. Om ingen bild anges skapas en miniatyrbild för den överförda resursen.
...
* **[!UICONTROL Tags]**
   ...
   (*valfri*) Du kan välja en eller flera taggar som associerar aktiveringsresursen med en eller flera kataloger. Se [Aktiveringsresurser för taggning](tag-resources.md).
...
* **[!UICONTROL Description]**
   ...
   (*valfri*) Beskrivningen som ska visas för aktiveringsresursen.

* **[!UICONTROL Small Asset]**

   (*valfri*) Markerat från AEM Assets. En miniatyrbild som representerar resursen i publiceringsmiljön, t.ex. i en katalog.

* **[!UICONTROL Large Asset]**

   (*valfri*) Markerat från AEM Assets. En stor bild som representerar resursen i publiceringsmiljön, till exempel på huvudsidan för en resurs.

* **[!UICONTROL Content Fragment Asset]**

   (*valfri*) Markerat från AEM Assets. Ett innehållsfragment som kan refereras i publiceringsmiljön, men som inte används som standard.
...
* **[!UICONTROL Add Image]**
   ...
   (*valfri*) En bild som ska visas på kortet för utbildningssökvägen på uppdragssidan och på resurskonsolen. Bilden väljs från serverns lokala filsystem. Om ingen bild anges skapas en miniatyrbild för den överförda resursen.

   ***Anteckning***: den rekommenderade bildstorleken inte längre bara är 480 x 480 pixlar. På grund av kortens responsiva design för olika webbläsardimensioner varierar visningsstorleken mellan 220 x 165 pixlar och 400 x 165 pixlar.
...
* **[!UICONTROL Tags]**
   ...
   (*valfri*) Du kan välja en eller flera taggar som associerar utbildningsvägen med en eller flera kataloger. Se [Aktiveringsresurser för taggning](tag-resources.md).
...
(
*valfri*) När andra publicerade utbildningsvägar har valts måste de vara klara innan en elev kan välja den här utbildningsvägen.
...
* **[!UICONTROL Enforce Order in Learning Path]**
   ...
   (*valfri*) om det är På, är den ordning i vilken lärarna måste gå igenom inlärningsvägen den ordning i vilken aktiveringsresurserna läggs till. Standardvärdet är Av.
