...
Se [Komma igång med AEM Communities](getting-started.md) om du vill se hur snabbt en community kan skapas i författarmiljön, och hur du kan skapa communitygrupper från författarmiljön och publiceringsmiljöer.

>[!NOTE]
>
>De viktigaste webbgruppsmenyerna för att skapa [communitysajter](sites-console.md), [mallar för communitysajter](sites.md), [communitygruppsmallar](tools-groups.md) och [communityfunktioner](functions.md) används endast i författarmiljön.
...
* Aktivera [tunneltjänst](deploy-communities.md#tunnel-service-on-author) hantera medlemmar och medlemsgrupper
...
* Installera [senaste funktionspaketet](deploy-communities.md#latestfeaturepack)
* Aktivera [Adobe Analytics](analytics.md) för AEM Communities
* Konfigurera [e-post](email.md)
* Identifiera [Community-administratörer](users.md#creating-community-members)
...
Följande bild visar till exempel huvudkonsolen Webbplatser i Communities som visar mapparna för två communityplatser: [enable](getting-started-enablement.md) och [engagera](getting-started.md):

![chlimage_1-448](assets/chlimage_1-448.png)

## Skapa webbplats {#site-creation}

Konsolen för att skapa webbplatser är en stegvis metod för att sätta ihop funktioner på webbplatsen baserat på ett valt [mall för communitywebbplats](sites.md) och inställningar.
...
>
>Konventionen gäller för publicering [användare och användargrupper](users.md) (medlemmar och medlemsgrupper) ska inte dupliceras i författarmiljön.
>
...
>
>Detta uppnås genom att aktivera ` [AEM Communities Publish Tunnel Service](deploy-communities.md#tunnel-service-on-author)`för redigeringsmiljön.
...
>[!NOTE]
>
>Vi rekommenderar att [communitysajter för aktivering](overview.md#enablement-community) vara privat (kontakta din kontorepresentant för mer information).
>
...
>
>Facebook- och Twitter-konfigurationer kan finnas och vara valbara för en [produktionsmiljö](../../help/sites-administering/production-ready.md)måste du skapa anpassade Facebook- och Twitter-program. Se [Social inloggning med Facebook och Twitter](social-login.md).
...
Om du väljer taggnamnutrymmen för communitywebbplatsen begränsas dessutom det urval som visas när du definierar kataloger och resurser. Se [Aktiveringsresurser för taggning](tag-resources.md) för viktig information.
...
The [roller för communitymedlemmar](users.md) har tilldelats med dessa inställningar.
...
* **[!UICONTROL Enable Analytics]**
   ...
   Endast tillgängligt när Adobe Analytics har [konfigurerad](analytics.md) för communityfunktioner.
...
* **[!UICONTROL Cloud Config Framework Reference]**
   ...
   `Communities`är ramverkets exempel från [Analyskonfiguration för communityfunktioner](analytics.md#aem-analytics-framework-configuration) dokumentation.
...
* **[!UICONTROL Enablement Managers]**
   ...
   (obligatoriskt) Endast medlemmar i `Community Enablementmanagers` gruppen är tillgänglig att väljas för att hantera den här aktiveringscommunityn. Aktivitetshanterare ansvarar för att tilldela medlemmar till resurser. Se även [Hantera användare och användargrupper](users.md).

* **[!UICONTROL Marketing Cloud Org Id]**

   (valfritt) ID:t för en [Analys av pulsslag för video](analytics.md#video-heartbeat-analytics) licens.
...
* Du kan redigera [STRUKTUR](#modify-structure) för en community-webbplats genom att ändra dess egenskaper
...
* En instans av en communityfunktion i webbplatsstrukturen:
   ...
   * **`gear icon`**
      ...
      Redigera inställningar, inklusive visningsrubrik och URL-namn&amp;ast;

      och [behöriga medlemsgrupper](users.md#privilegedmembersgroups)
...
Efter publicering av en communitywebbplats är det nödvändigt att publicera varje undergrupp (kapslad grupp) som skapats med [Gruppkonsol](groups.md).
...
>
skapas, används [Facebook molntjänst](social-login.md#createafacebookcloudservice) bör konfigureras för att lägga till användare i den här gruppen.
...
* Välj `pencil`ikon för att öppna konfigurationen för redigering
* Ange **[!UICONTROL Login Page Mappings]** enligt följande:
