...
* [Avancerad tilldelning av märken](advanced.md) för att identifiera medlemmar som experter (kvaliteten på det material som skapas)
...
* Märkning måste vara [aktiverat](#enable-badges-for-component) för funktionskomponenten
...
* Tilldela [märken](#badges) ([badging-regler](#badging-rules)) för poäng som samlas per poängregler
...
En boolesk egenskap, `allowBadges`, aktiverar/inaktiverar visning av emblem för en komponentinstans. Den kan konfigureras i dialogrutan [för](author-communities.md) komponentredigering för forum-, QnA- och kommentarkomponenter via en kryssruta med etiketten **Display Badges**.
...
I releasen finns två poängregler för [forumfunktionen](functions.md#forum-function) (en för respektive forum och kommentarkomponenter för forumfunktionen):
...
<table> 
 <tbody> 
  ...
  <tr> 
   <td>badgingType</td> 
   <td>Sträng</td> 
   <td><em>(valfritt)</em> Identifierar bedömningsmotorn som antingen grundläggande eller avancerad. Om du vill använda den avancerade poängsättningsmotorn läser du i <a href="advanced.md">Avancerade poäng och märken</a>. Standardvärdet är "basic".</td> 
  </tr> 
  <tr> 
   <td> 
...
Medlemmar kan tilldelas märken antingen med hjälp av [medlemskonsolen](members.md#badges-tab) eller via programmering med hjälp av cURL-kommandon.
...
>[!NOTE]
>
>En ny boolesk egenskap, `allowBadges`, aktiverar/inaktiverar visning av emblem för en komponentförekomst. Den kan konfigureras i uppdaterade dialogrutor [för](author-communities.md) komponentredigering via en kryssruta med etiketten **Display Badges**.

**[Calendar Component](calendar.md)**SocialEvent`topic`= com/adobe/cq/social/calendar
...
**[Röstkomponent](voting.md)**SocialEvent`topic`= com/adobe/cq/social/tally/voting
...
Publicera sedan [communitywebbplatsen igen](sites-console.md#publishing-the-site) .
...
Den konfigurerbara [komponenten](enabling-leaderboard.md) och [funktionen](functions.md#leaderboard-function) för ledningsgruppen förenklar visningen av medlemmar och deras poäng på en communitywebbplats.
