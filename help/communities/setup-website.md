...
1. Skapa `/apps/an-scf-sandbox` mapp.
   ...
   1. Högerklicka **[!UICONTROL Create]**.. eller dra ned **[!UICONTROL Create...]** menyn
...
1. Markera **[!UICONTROL Designs]** mappen i Utforskarfönstret och klicka sedan på **[!UICONTROL New > New Page]**.
