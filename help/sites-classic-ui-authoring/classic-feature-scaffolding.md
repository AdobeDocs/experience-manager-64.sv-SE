...
&quot;This specifies that component to be used to render the text content of this paragraph is the *Text Image* component. Med det booleska värde som anges i det andra dolda fältet kan komponenten återge den faktiska textsträng som lagras på `isRichText` `./jcr:content/par/text/text` det sätt som du vill.
