...
![Redigera dialogrutan för bildkomponenten i det klassiska användargränssnittet; visar fältet Alt-text.](assets/chlimage_1-17.png)

AEM lägger till en **Alt-text** i bilderna som standard. För det klassiska användargränssnittet finns det två olika scenarier för hur standardattributet skapas (även om standardvärdet kanske inte är tillräckligt som ett alternativ och troligen måste redigeras på fliken **Avancerade** bildegenskaper):
...
* Diagram och diagram:
   ...
   ![Exempel på ett diagram. Nedan visas det bästa sättet att erbjuda ett alternativ.](assets/chlimage_1-2.jpeg)
...
* **Använd tabeller**:
   ...
   * Ta helst bort alla standardvärden för **Bredd**, **Höjd**, **Kant**, **Cellfyllnad** och **Cellmellanrum** eftersom dessa egenskaper kan anges i en global formatmall.
   ...
   ![Dialogrutan Tabellegenskaper.](assets/chlimage_1-20.png)
   ...
   ![Dialogruta för samtalsegenskaper. ange en rad (vanligtvis den första) som en rubrikrad.](assets/chlimage_1-21.png)
...
![Fliken Titel och Text (dialogrutan Redigera); Rubriken&quot;Beskrivning&quot; har lagts till.](assets/chlimage_1-22.png)
...
![Bildknappen med Alt-texten inställd i fältet Titel (redigeringsdialogrutan).](assets/chlimage_1-23.png)
...
![Lägger till objekt i gruppen med alternativknappar. Grupptiteln är &#39;Kontakta mig via&#39; - definieras i fältet Titel.](assets/chlimage_1-24.png)
...
![Lägga till ytterligare information (det ord som krävs) för skärmläsaranvändare i fältet Titel.](assets/chlimage_1-25.png)
