...
[!UICONTROL Dynamic Media] och [!UICONTROL Interactive Media] finns i [!UICONTROL Sidekick] under **[!UICONTROL Dynamic Media]**. Du använder komponenten för alla interaktiva resurser, till exempel interaktiv video, interaktiva bilder eller karuselluppsättningar. **[!UICONTROL Interactive Media]** Använd **[!UICONTROL Dynamic Media]** komponenten för alla andra dynamiska mediekomponenter.
